        ...
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              var wishlistData = wishlistDocs[index].data() as Map<String, dynamic>;
              String tractorId = wishlistData['tractorId'];

              return FutureBuilder<DocumentSnapshot>(
                future: FirebaseFirestore.instance.collection('tractors').doc(tractorId).get(),
                builder: (context, tractorSnapshot) {
                  if (tractorSnapshot.connectionState == ConnectionState.waiting) {
                    return const Center(child: CircularProgressIndicator());
                  }
                  if (!tractorSnapshot.hasData || !tractorSnapshot.data!.exists) {
                    return const Center(child: Text("Tractor not found"));
                  }

                  var tractor = tractorSnapshot.data!.data() as Map<String, dynamic>;
